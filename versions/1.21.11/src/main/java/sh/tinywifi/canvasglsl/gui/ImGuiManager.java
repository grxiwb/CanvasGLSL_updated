...
public final class ImGuiManager {
    ...
    public boolean beginFrame() {
        ...
        // Override DisplaySize/DisplayFramebufferScale so ImGui renders
        // at framebuffer resolution instead of logical window resolution.
        // GLFW backend sets DisplaySize to window (logical) pixels which breaks
        // HiDPI and Minecraft GUI Scale > 1 — we correct it here.
        ImGuiIO io = ImGui.getIO();
        io.setDisplaySize(framebufferWidth, framebufferHeight);
